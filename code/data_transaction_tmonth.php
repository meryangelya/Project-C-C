...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>Transaction Data This Month</title>
    ...
    <body id="body">
    	<div align='center'>           
            <div id="box1">
                ...
                <br><font color="#000000" style="font-size:36px" face="Century Gothic">Transaction Data This Month</font>
                </div>
                <br>
                  ...
                  <table>
                      ...
                      <?php  
						$queri="SELECT * FROM trlaundry WHERE YEAR(TglTerima) = YEAR(NOW()) AND MONTH(TglTerima)=MONTH(NOW())";						
